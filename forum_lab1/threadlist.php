...
<head>
    ...
    <title>Welcome to iLearn - Coding Forums</title>
</head>
        ...
        $sno = $_POST['sno'];
            ...
            if ($result) {
                ...
                echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <strong>Error!</strong> There was an issue adding your thread. Please try again later.
...
if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
    ...
    if ($method == 'POST') {
        ...
        if (empty($th_title) || empty($th_desc)) {
            ...
            // Insert into the thread database
   ...
   window.history.replaceState("","",window.location.href)
    ...
    while($row = mysqli_fetch_assoc($result)){
        ...
        echo '<div class="media my-3">
            <img src="img/image-png.png" width="54px" class="mr-3" alt="...">
